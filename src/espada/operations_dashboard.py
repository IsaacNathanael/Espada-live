...
/* Formal maritime command theme. Raw SAR remains visually distinct and unaltered on request. */
:root{--bg:#e8edf0;--panel:#fff;--panel2:#f4f6f7;--line:#c8d1d7;--ink:#112b40;--muted:#687984;--cyan:#2d5a78;--amber:#d18b22;--red:#b74b52;--green:#287d5a}
body{background:#e8edf0;color:var(--ink);font-family:"Segoe UI Variable",Segoe UI,Arial,sans-serif}.app{background:#e8edf0}header{background:#fff;border-bottom-color:#bcc7ce;box-shadow:0 2px 12px #203b4d18}.brand{color:#0b2a43}.mark{border-color:#7890a1;color:#173f5c;background:#edf2f5}.case{border-left-color:#cad2d8}.badge{border-color:#d8a34d;background:#fff7e8;color:#8a5a0c}.server{color:#71808a}.server.on{color:#287d5a}.primary{border-color:#173f5c;background:#173f5c;color:#fff}.soft{border-color:#bdc8cf;background:#f5f7f8;color:#23445c}.workspace{background:#e8edf0}.map-card,.side{border-color:#bfcbd2;background:#fff;box-shadow:0 5px 18px #203b4d12}.map-card{background:#aebbc3}.sar{opacity:.52;filter:grayscale(1) contrast(1.08) brightness(1.38);mix-blend-mode:multiply}.map-card.raw-mode .sar{opacity:.96!important;filter:grayscale(1) contrast(1.12) brightness(.88);mix-blend-mode:normal}.map-shade{background:linear-gradient(90deg,#dfe7eb30,#b8c6ce08),radial-gradient(circle at 55% 45%,transparent,#6176842c)}.gridline{stroke:#294e6733}.tool{border-color:#95a8b4;background:#fffffff0;color:#173a53;box-shadow:0 2px 8px #1f3b4c18}.tool[aria-pressed=true]{border-color:#173f5c;color:#173f5c;background:#e8eff3}.map-status,.coverage-live,.legend{background:#fffffff2;border-color:#9aabb5;color:#4f6472;box-shadow:0 3px 10px #243c4d18}.map-status b,.coverage-live b{color:#173f5c}.legend{color:#314a5c}.oil-return{fill:#2b251fd9;stroke:#d18b22;filter:drop-shadow(0 1px 2px #fff7)}.detection{stroke:#d18b22;filter:none}.release{fill:#2d5a781b;stroke:#214e6b;filter:none}.particle{fill:#173f5c}.traffic-trail{stroke:#2d5a78;opacity:.4}.traffic-trail.top,.track.top{stroke:#c67d12}.track{stroke:#173f5c}.report-dot{fill:#173f5c}.ship path{fill:#2d5a78;stroke:#fff;filter:drop-shadow(0 1px 2px #1b334866)}.ship.top path{fill:#d18b22}.tooltip{border-color:#8da0ac;background:#fffffff7;color:#173044;box-shadow:0 12px 30px #1d34452b}.tooltip span{color:#647784}.popover{border-color:#9aabb5;background:#fffffff8;color:#19364b;box-shadow:0 8px 22px #20384624}.phase div{border-color:#9aabb5;background:#fffffff2;color:#667985}.phase div.on{border-color:#234f6d;color:#173f5c}.side-head{border-bottom-color:#d5dce0}.eyebrow{color:#315d79}.side-head h2,.detail h3,.modal h2{font-family:Bahnschrift,"Segoe UI Variable",Segoe UI,sans-serif;color:#112f46}.decision-summary{border-color:#d4dade;background:#f5f7f8}.decision-summary b{color:#173f5c}.decision-summary.abstain{border-color:#d7a550;background:#fff8eb}.candidate{border-color:#d2d9de;background:#fff;color:#173044}.candidate:hover,.candidate.active{border-color:#6f899a;background:#edf2f5}.rank{background:#e2eaf0;color:#173f5c}.candidate:first-child .rank{background:#f5dfb8;color:#7a500f}.detail{border-color:#ced7dc;background:#f5f7f8}.metric{background:#fff;border:1px solid #d8dfe3}.bar{background:#dce3e7}.detail-actions button,.detail-actions a{border-color:#b9c6cd;background:#fff;color:#173f5c}.notice{color:#74551d}.timeline,.weather{border-color:#becad1;background:#fff;box-shadow:0 3px 12px #203b4d10}.play{border-color:#688295;background:#173f5c;color:#fff}.timebox{color:#244f6c}.weather button{border-right-color:#d2d9de;color:#173044}.arrow{color:#315d79}.profile-line span{border-color:#c8d2d8;color:#435c6c;background:#fff}.bottom{background:#e8edf0}.phase div.done{color:#287d5a}dialog{border-color:#aebdc6;background:#fff;color:#173044;box-shadow:0 30px 90px #1a2e3d66}dialog::backdrop{background:#14283780}.close{color:#546b79}.fact{border-top-color:#d7dee2}.disclosure{background:#fff4dc;color:#6e511b}.spark{background:#edf2f5}
dialog{width:min(620px,calc(100% - 24px));padding:0;border:1px solid #aebdc6;border-radius:14px;background:#fff;color:#173044;box-shadow:0 30px 90px #1a2e3d66}dialog::backdrop{background:#14283780;backdrop-filter:blur(3px)}.modal{padding:19px}.modal-head{display:flex;justify-content:space-between}.modal h2{margin:4px 0 12px;font:700 27px Bahnschrift,"Segoe UI Variable",Segoe UI,sans-serif;color:#112f46}.close{border:0;background:none;color:#546b79;font-size:24px;cursor:pointer}.fact{display:grid;grid-template-columns:160px 1fr;gap:10px;padding:9px 0;border-top:1px solid #d7dee2}.fact span{color:#667985}.disclosure{padding:11px;border-left:3px solid var(--amber);background:#fff4dc;color:#6e511b;margin-top:12px}.spark{width:100%;height:150px;background:#edf2f5;border-radius:10px}.hidden{display:none!important}
